import styles from "../styles/lastComponent.module.css"

const LastComponent = () => {
     return (
          <div className={styles.container} >
               <div className={styles.container_upper}>
                    <h1 className={styles.container_heading}>Make your dreams a <span className={styles.container_yellow}>Reality</span></h1>
                    <div className={styles.lastCol} >
                         <span className={styles.lastCol_span} >WORK WITH US</span>
